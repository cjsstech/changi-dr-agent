...
function editPrompt(filename) {
    ...
    fetch(`/admin/prompts/${encodeURIComponent(filename)}`)
        .then(response => response.json())
        .then(data => {
            if (data.success) {
...
function savePrompt() {
    ...
    if (currentEditingPrompt) {
        ...
        fetch(`/admin/prompts/${encodeURIComponent(currentEditingPrompt)}`, {
            method: 'PUT',
...
function editWorkflow(workflowId) {
    fetch(`/admin/workflows/${workflowId}`)
        .then(response => response.json())
        .then(data => {
            if (data.success) {
...
function deleteWorkflow(workflowId) {
    ...
    fetch(`/admin/workflows/${workflowId}`, { method: 'DELETE' })
        .then(response => response.json())
        .then(data => {
            if (data.success) {
...
function saveWorkflow() {
    ...
    const url = currentEditingWorkflowId ? `/admin/workflows/${currentEditingWorkflowId}` : '/admin/workflows';
